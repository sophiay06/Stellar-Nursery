...
namespace SpaceGraphicsToolkit.Atmosphere
{
	...
	[HelpURL(SgtCommon.HelpUrlPrefix + "SgtAtmosphereSoil")]
	[AddComponentMenu(SgtCommon.ComponentMenuPrefix + "Atmosphere Soil")]
	public class SgtAtmosphereSoil : MonoBehaviour
	{
...
{
	using UnityEditor;
	using TARGET = SgtAtmosphereSoil;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class SgtAtmosphereSoil_Editor : CwEditor
	{
