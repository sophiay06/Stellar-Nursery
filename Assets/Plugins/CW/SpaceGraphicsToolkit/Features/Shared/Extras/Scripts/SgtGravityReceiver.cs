...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtGravityReceiver : MonoBehaviour
	{
		...
		protected virtual void FixedUpdate()
		{
			...
			var linAccel = CalculateAcceleration(transform.position, cachedRigidbody.mass) * Time.fixedDeltaTime;

			#if UNITY_6000_0_OR_NEWER
				cachedRigidbody.linearVelocity += linAccel;
			#else
				cachedRigidbody.velocity += linAccel;
			#endif
