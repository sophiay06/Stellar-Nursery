	...
	public class SgtProximityDrag : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			if (distance < distanceMax)
			{
				...
				linDrag = Mathf.Lerp(dragMax, dragMin, distance01);
				angDrag = Mathf.Lerp(angularDragMax, angularDragMin, distance01);
			}

			#if UNITY_6000_0_OR_NEWER
				cachedRigidbody.linearDamping  = linDrag;
				cachedRigidbody.angularDamping = angDrag;
			#else
				cachedRigidbody.drag        = linDrag;
				cachedRigidbody.angularDrag = angDrag;
			#endif
		}
	}
}
