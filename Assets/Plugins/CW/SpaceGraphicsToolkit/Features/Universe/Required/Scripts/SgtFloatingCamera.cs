...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtFloatingCamera : SgtFloatingPoint
	{
		...
		/// <summary>The maximum camera distance objects can render at when using the <b>SgtFloatingMassive</b> component.
		/// NOTE: This should be lower than the Main Camera's <b>Clipping Planes / Far</b> setting.</summary>
		public double MassiveDistance { set { massiveDistance = value; } get { return massiveDistance; } } [SerializeField] private double massiveDistance = 100000;
