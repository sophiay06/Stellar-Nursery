...
namespace SpaceGraphicsToolkit
{
	...
	public static class SgtTerrainTopology
	{
		...
		{
			var rotation = (double3x3)new float3x3(quaternion.Euler(math.atan(1.0f / math.sqrt(2.0f)), 0.0f, 0.785398f));
		...
		{
			var rotation = (double3x3)new float3x3(math.inverse(quaternion.Euler(math.atan(1.0f / math.sqrt(2.0f)), 0.0f, 0.785398f)));
